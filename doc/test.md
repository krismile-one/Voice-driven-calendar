...
| 3 | 单元测试 - 时间解析 | tests/unit/test_time_parser.py | 3 | ⬜ 未实现 | 取消time_parser计划 |
| 4 | 集成测试 - 事件API | tests/integration/test_api_events.py | 4 | ✅ 实现 | - |
...
| 2 | 事件圆点 | 查看日历日期格子 | 5/28、5/31、6/1、6/3、6/5、6/10 有红色小圆点 | ✅ |
| 3 | 今天多事件 | 查看 5/31 格子 | 3 +圆点（团队晨会、项目评审、晚餐聚会） | ✅ |
...
| 4 | 默认渐变背景 | 渐变背景目前没有实现 | 已经处理 |
| 5 | 数字对齐 | 日期数字没有对齐，会被下方的提醒红点挤得偏高 | 已处理 |
